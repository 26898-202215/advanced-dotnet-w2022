...
namespace Week07_1_HttpListener
{
    class Program
    {
        ...
        /// <remarks>This example requires the System and System.Net namespaces.</remarks>
        static void Main(string[] args)
        {
            ...
            listener.Prefixes.Add("http://*:21000/demo/"); //Because of the wildcard, This will work with things like: http://localhost:21000/demo   OR http://127.0.0.1:21000/demo  OR your actual machine name or IP as long as th eport is 21000
        ...
        private static async void HandleRequest(IAsyncResult result)
        {
            ...
            var writeTask = context.Response.OutputStream.WriteAsync(response, 0, response.Length);
